    ...
    <body>
        <header> 
            <div id="sfondo">
                <nav>
                    <div id="links">
                        <a href="<?php echo e(route('logout')); ?>" class="button">Logout</a>
                    </div>
                </nav>
        ...
        <main>
           ...
           <section id="prima">
                <div class="sinistra">
                    <div id="mybooks">
                        <a href="<?php echo e(route('mybooks')); ?>" class="titolo">
                        ...
                        <span>
                            <a href="<?php echo e(route('mybooks')); ?>" class="icone">
                ...
                <div class="destra">
                    <div id="recensioni">
                        <a href="<?php echo e(route('recensioni')); ?>" class="titolo">
                        ...
                        <span>
                            <a href="<?php echo e(route('recensioni')); ?>" class="icone">
            ...
            <section id="seconda">
                <div class="sinistra">
                    <div id="rubrica">
                        <a href="<?php echo e(route('columnlogin')); ?>" class="titolo">
                        ...
                        <article>
                            <span>
                                <a href="<?php echo e(route('columnlogin')); ?>" class="icone">
                ...
                <div class="destra">
                    <div class="piccolo" id="libroperfetto">
                        <a href="<?php echo e(route('libroperfetto')); ?>" class="titolo">
                        ...
                        <span>
                            <a href="<?php echo e(route('libroperfetto')); ?>" class="icone">
