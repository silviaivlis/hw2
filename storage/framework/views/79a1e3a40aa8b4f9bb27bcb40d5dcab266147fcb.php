<html>
    <head>
        ...
        <meta charset="utf-8">
        <link rel="stylesheet" href="<?php echo e(url('css/rubrica.css')); ?>" />
        <script src="<?php echo e(url('js/rubricaletteraria.js')); ?>" defer></script>
    ...
    <body>
        <header> 
            <div id="sfondo">
                ...
                <a href="<?php echo e(route('homepage')); ?>" class="titolo">
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/hw2/resources/views/column.blade.php ENDPATH**/ ?>